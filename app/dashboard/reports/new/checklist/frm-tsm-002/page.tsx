...
import { submitFrmTsm002Checklist } from "./actions"

export const dynamic = "force-dynamic"

type FrmTsm002PageProps = {
...
export default async function FrmTsm002Page({
  searchParams,
}: FrmTsm002PageProps) {
  ...
  if (!params.areaId || params.period !== "MONTHLY") {
    return unavailable(
      "Form belum tersedia",
      "FRM_TSM_002 hanya tersedia untuk checklist Monthly pada tahap ini."
    )
  }
  ...
  return (
    <ReportFlowShell
      ...
      description="Pilih kondisi setiap item. Bukti foto wajib dilampirkan jika ditemukan kondisi yang rusak."
    >
      <SharedChecklistForm
        ...
        formCode="FRM_TSM_002"
        submitAction={submitFrmTsm002Checklist}
      />
    </ReportFlowShell>
  )
}