...
import { submitFrmTsm005Checklist } from "./actions"
import { FRM_TSM_005_CONFIG } from "@/lib/checklists/frm-tsm-005"

export const dynamic = "force-dynamic"

type FrmTsm005PageProps = {
...
export default async function FrmTsm005Page({
  searchParams,
}: FrmTsm005PageProps) {
  ...
  if (!params.areaId || params.period !== "MONTHLY") {
    return unavailable(
      "Form belum tersedia",
      "FRM_TSM_005 hanya tersedia untuk checklist Monthly pada tahap ini."
    )
  }
  ...
  return (
    <ReportFlowShell
      eyebrow="FRM_TSM_005"
      title="Checklist Fisik Bangunan"
    ...
    >
      <SharedChecklistForm
        ...
        config={FRM_TSM_005_CONFIG}
        submitAction={submitFrmTsm005Checklist}
      />
    </ReportFlowShell>
  )
}