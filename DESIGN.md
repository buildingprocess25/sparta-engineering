...
Use system sans-serif stacks. Type should be compact, confident, and readable on mobile. Labels and workflow codes may use tighter data-style treatment, but body copy should stay plain Indonesian operational language.

## Layout

Design mobile-first. The ES dashboard should present one clear work path at a time:

1. Greeting and role context.
2. Primary workflow decision.
...
- Buttons use clear verbs and icons.
- Choice panels should behave like large touch targets.
- Status chips use restrained semantic color with orange for active/attention.
- Cards and panels keep modest radius and avoid nested-card structures.
- Avoid default "AI dashboard" patterns such as oversized decorative hero cards, scattered glow accents, ornamental sparkle icons, and equal-weight feature cards.

## Motion

Use minimal motion: a single soft entrance or shine is acceptable, but workflow clarity matters more than effects. Hover/focus states must be obvious.

## Accessibility

Maintain strong contrast on dark surfaces. Touch targets should be comfortable on mobile. Focus states must remain visible against black and silver backgrounds.
